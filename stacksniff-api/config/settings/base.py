...
env = environ.Env()
# Try reading the .env file if it exists
environ.Env.read_env(os.path.join(BASE_DIR, ".env"))

SECRET_KEY = env.str("SECRET_KEY", default="django-insecure-default-key-to-be-overridden")
...
# Database
# Default to SQLite, overridden in settings profiles if needed
DATABASES = {
